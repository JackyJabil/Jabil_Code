                ...
                {                  
                    ...
                    if ((!Taskfinish) && (!AllTaskfinish))
                    {
                        ...
                        else
                        {
                            ...
                            _netConnection.Call("my-amf", "net", "PortalCAMXGetMachineOEE", "getData", new RemoteHandler(), new Object[] { myServer, int.Parse(equipID[num]), 0, GetShiftStartTime().ToString("yyyy-MM-dd HH:mm:ss"), null, 1 });
